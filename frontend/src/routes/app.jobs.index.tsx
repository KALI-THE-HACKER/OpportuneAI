...
function JobExplorer() {
  ...
  return (
    <>
      <PageHeader
        title="Job explorer"
        description="Search, filter, and sort thousands of high-signal opportunities."
      />
        ...
        <div className="min-w-0">
          ...
          {query.isLoading ? (
            ...
            <EmptyState
              ...
              description="Try widening salary, location, or experience filters."
            />
          ) : (
            <>
  ...
  return (
    <label className="flex items-center gap-2 text-sm text-foreground cursor-pointer">
      <input
        ...
        checked={checked}
        onChange={onChange}
        className="size-4 rounded ring-1 ring-border accent-accent"
      />
